...
public class SchoolNameRequest implements SchoolNameRequestInterface {
    public SchoolNameResponse mSchoolsNameResponse;
    ...
    public void getSchoolName(String name) {
        ...
        */
        Call call = schoolsApi.getSchoolDetails(name);
        /*
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (response.body() != null) {
                    mSchoolsNameResponse = (SchoolNameResponse) response.body();
