...
public class SchoolsRequest implements SchoolsRequestInterface {
    SchoolsResponse mSchoolsResponse;

    @Override
    public void getSchoolData(String city) {
        //Obtain an instance of Retrofit by calling the static method.
        Retrofit retrofit = NetworkClient.getRetrofitClient();
        /*
        The main purpose of Retrofit is to create HTTP calls from the Java interface based on the annotation associated with each method. This is achieved by just passing the interface class as parameter to the create method
        */
        SchoolsApi weatherAPIs = retrofit.create(SchoolsApi.class);
        /*
        Invoke the method corresponding to the HTTP request which will return a Call object. This Call object will used to send the actual network request with the specified parameters
        */
        Call call = weatherAPIs.getSchoolByCity(city);
        /*
